class Types::ElementType < Types::BaseObject
  ...
  field :periodic_inspection, Types::PeriodicInspectionType, null: true do
    description "Find a periodic inspection based on a date"
    argument :date, String, default_value: Date.today, required: true
  end
  field :preuse_inspection, Types::PreuseInspectionType, null: true do
